...
type Session struct {
	...
	// HyperNodesList contains a list of hyperNodes by tier from down to top, nodes under the same hyperNode
	...
	HyperNodesList [][]string
	// HyperNodeGroups maps hyperNode Name -> nodes under the hyperNode.
	HyperNodeGroups map[string][]*api.NodeInfo
